...
public:
  ...
  Mission() : state(0), inbound_counter(0), outbound_counter(0), break_counter(0),land_flag(false),land_t(0),touchdown_counter(0),acc_land(0),t_fac(3),init_vel_land(0.0),arm(false),icp_pp(false),wait_counter(0),up_counter(0),yaw_rate(0.0),t_est(0.0),
